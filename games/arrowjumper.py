...
# Set up the dino (loads from ../images/)
dino_width = 100
dino_height = 100
dino_x = 100
dino_y = 350
...
dino_jump_vel = 22
dino_jump = False
dino_img = pygame.image.load('../images/lucky.jpg')
o = pygame.transform.scale(dino_img, (dino_width, dino_height))

# Set up the cactus (loads from ../images/)
cactus_width = 32
cactus_height = 64
cactus_x = win_width + cactus_width
cactus_y = win_height - cactus_height - 50
cactus_vel = 15
cactus_img = pygame.image.load('../images/cactus.png')

# Set up the score and background (loads from ../images/)
score = 0
